...
function CreateProblem() {
  ...
  const handleAddTestcase = (testcase) => {
    ...
    console.log(`Testcase added: Input = ${testcase.input}, Output = ${testcase.output}`);
  };
  ...
  //     };
  //     try {
  //       //const response = await axios.post('http://localhost:5175/homepage', payload);
  //       //console.log('Problem created successfully:', response.data);
  //       console.log('Problem Created:', { problemName, detail,stake,testcases});
  ...
  //     }
  //   } else {
  //     alert('Please fill both the Problem Name and Detail fields');
  //   }
  //   setProblemName('');
  //   setDetail('');
  //   setStake('');
        ...
        <ul>
          {testcases.map((testcase, index) => (
            <li key={index} style={{ marginBottom: '5px' }}>
              ...
              <button onClick={() => handleDeleteTestcase(index)} style={{ marginLeft: '10px' }}>
                Delete
              </button>
            </li>
          ))}
